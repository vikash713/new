...
<body>
    <div class="container">
        <form action="#" method="post" name="register"  id="registerform" onsubmit="return validateForm()">
            ...
            <div class="form">
                ...
                <div class="input_feild">
                    <input type="submit" value="Register" class="dbregister" name="Register">
                </div>
            </form>
            <?php
